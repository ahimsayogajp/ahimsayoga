...
var _user$project$Types$Model = F3(
	function (a, b, c) {
		return {currentPage: a, navbarState: b, translations: c};
	});
...
var _user$project$Routing$locFor = function (location) {
	return _user$project$Types$GoTo(
		A2(_evancz$url_parser$UrlParser$parseHash, _user$project$Routing$route, location));
};
...
var _user$project$App$init = function (location) {
	...
	var page = function () {
		var _p4 = A2(_evancz$url_parser$UrlParser$parseHash, _user$project$Routing$route, location);
		if (_p4.ctor === 'Nothing') {
	...
	var initialModel = {currentPage: page, navbarState: navbarState, translations: _ChristophP$elm_i18next$I18Next$initialTranslations};
	return {
		ctor: '_Tuple2',
		_0: initialModel,
...
var _user$project$Footer$render_footer = function (model) {
	return A2(
					...
					},
					{
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$href('/#/en'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
					...
					},
					{
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$href('/#/en/about'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
					...
					},
					{
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$href('/#/en/instructors'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
					...
					},
					{
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$href('/#/en/contact'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
...
var _user$project$Pages_Home$content = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _user$project$Pages_Home$update = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Pages_Home$content(model),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
...
var _user$project$Pages_Schedule$content = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
								...
								_1: {
																							...
																							_0: A2(
																								...
																								},
																								{
																									...
																									_0: _elm_lang$html$Html$text(
																										A2(
																											_elm_lang$core$Basics_ops['++'],
																											A2(_ChristophP$elm_i18next$I18Next$t, model.translations, 'schedule.locations.takigahara.detail'),
																											' *')),
																									_1: {ctor: '[]'}
																								}),
																							_1: {
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('schedule-extra-detail'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(
													A2(
														_elm_lang$core$Basics_ops['++'],
														'* ',
														A2(_ChristophP$elm_i18next$I18Next$t, model.translations, 'schedule.detail'))),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
...
var _user$project$Pages_About$content = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _user$project$Pages_Instructors$content = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _user$project$Pages_Contact$content = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _user$project$Main$main = A2(
	...
	_user$project$Routing$locFor,
	{init: _user$project$App$init, update: _user$project$App$update, view: _user$project$View$view, subscriptions: _user$project$App$subscriptions})();
